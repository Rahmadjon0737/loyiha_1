        ...
        <div className='max-w-md  m-auto '>
            ...
            <div className='bg-white grid  relative top-[-20px] py-6 px-3 text-[#012F56] font-[600] '>
                ...
                <div className="mt-24 space-y-4 grid">
                    <button className='bg-[#1A94FF] text-white w-full  text-[20px] h-[61px] rounded-[10px] '>Зарегистрироваться
                    </button>
                    <NavLink to={'/pages_16'} className='border-[1.5px]  flex items-center justify-center border-[#1A94FF] text-[1A94FF] w-full text-[20px] h-[61px] rounded-[10px]'>Ввести другой номер</NavLink>
                </div>
            </div>
        </div>
    )
